# Instagram Trademarks Logo 1200x1200 | (Holloway) Chew, Kean Ho's Visuals

[![logo](/Pictures/banner_1200x1200.svg)](#)

The Instagram Trademarks Logo. They published clear trademark guidelines but
supplied a set of broken material files for it. The preferred version is pure
`.svg` (no rasterized images embedding) which has non-destructive scale up &
down properties and can be converted into any rasterized images (e.g. `jpeg`,
`webp`, `avif`, etc). To comply with our standards, a re-draw is required.

This project re-draws Instagram Trademarks Logo specifically for 1200x1200 size.
...
Since Instagram published good trademark guideline, from time to time, **please
go through each of the following to avoid any unwanted implications**:

* https://www.meta.com/brand/resources/instagram/instagram-brand

While not specified by Instagram, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: Instagram Trademarks Logo 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-instagram-1200x1200
UUID: 5E7B3871-0E28-45D7-A678-D3A3FA664D71
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-02-08
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/visuals-trademarks-instagram-1200x1200
--------------------------------------------------------------------------------
```
...
> COMPLY WITH META'S INSTAGRAM TRADEMARK REQUIREMENTS
> (Read: https://www.meta.com/brand/resources/instagram/instagram-brand)**.
>
